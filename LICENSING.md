...
A `LICENSE-crewai` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI), Copyright
2025 crewAI, Inc, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../crewai-port/specs/SPEC-001-crewai.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
